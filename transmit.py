...
class transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.target_freq = target_freq = 433.903e6
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\andre\\Desktop\\captured_key_1.dll', True, 0, 0)
