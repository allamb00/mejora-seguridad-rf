...
class jammer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_center_freq(target_freq, 0)
        ...
        self.connect((self.osmosdr_source_0, 0), (self.band_pass_filter_1, 0))
    ...
    def set_target_freq(self, target_freq):
        ...
        self.rtlsdr_source_0.set_center_freq(self.target_freq, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_1.set_taps(firdes.band_pass(1, self.samp_rate, 1, 20e3, 100, window.WIN_HAMMING, 6.76))
